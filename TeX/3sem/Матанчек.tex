...
\begin{lemma}
    [об единственности меры на $\mathcal A$]
...
\begin{theorem}
    [теорема об аппроксимации измеримых функций]
...
\begin{corollary}
    [Монотонность интеграла неорицательной функции от множества.]

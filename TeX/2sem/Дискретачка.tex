...
\begin{document}
    ...
    \end{definition}
    \begin{note}
        Альтернативное определение независимости, не поддерживающее 0: $P(A\cap B) = A$
    \end{note}
    ...
    \end{theorem}
    \begin{proof}
        $P\left( A_1\times \Omega_2 \cap \Omega_1\cap A_2 \right)  = P\left( A_1\times A_2 \right) = \sum\limits_{\substack{a\in A_1\\b\in A_2}} p\left( \left<a, b \right> \right)  = \\ = \sum\limits_{a\in A_1} \sum\limits_{b\in A_2} p_1(a)\cdot p_2(b) = \sum\limits_{a\in A_1}p_1(a)\left( \sum\limits_{b\in A_2} p_2(b) \right) = P_1(A_1)\cdot P_2(A_2)$
    \end{proof}
    ...
    \begin{definition}
        ...
        \begin{enumerate}
            ...
            \item Независимы в совокупности $\forall I\subseteq \{1, 2, \ldots, n\}\quad P\left( \bigcap\limits_{i\in I}A_i \right)  = \prod\limits_{i\in I} P(A_i)$
